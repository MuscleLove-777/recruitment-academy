/* ============================================
   Recruitment Academy - Main Application
   ============================================ */
...
const App = {
    ...
    init() {
        ...
        if (localStorage.getItem('recruitment-darkmode') === 'true') {
    ...
    loadProgress() {
        try {
            const saved = localStorage.getItem('recruitment-progress');
            if (saved) this.progress = JSON.parse(saved);
            const savedQuiz = localStorage.getItem('recruitment-quiz-results');
    ...
    saveProgress() {
        localStorage.setItem('recruitment-progress', JSON.stringify(this.progress));
        localStorage.setItem('recruitment-quiz-results', JSON.stringify(this.quizResults));
    },
    ...
    showDashboard() {
        ...
        let html = '<div class="fade-in">' +
            '<div class="dashboard-hero"><h2>\u63A1\u7528\u30A2\u30AB\u30C7\u30DF\u30FC \u3078\u3088\u3046\u3053\u305D</h2>' +
            '<p>\u4F01\u696D\u306E\u63A1\u7528\u6D3B\u52D5\u3092\u57FA\u790E\u304B\u3089\u5B9F\u8DF5\u307E\u3067\u4F53\u7CFB\u7684\u306B\u5B66\u3076\u6559\u80B2\u30D7\u30ED\u30B0\u30E9\u30E0\u3067\u3059\u3002</p></div>' +
    ...
    toggleDarkMode() {
        ...
        if (isDark) {
            ...
            localStorage.setItem('recruitment-darkmode', 'false');
        } else {
            document.documentElement.setAttribute('data-theme', 'dark');
            localStorage.setItem('recruitment-darkmode', 'true');
        }
    },
    ...
    resetProgress() {
        if (confirm('\u5168\u3066\u306E\u5B66\u7FD2\u9032\u6357\u3092\u30EA\u30BB\u30C3\u30C8\u3057\u307E\u3059\u304B\uFF1F\u3053\u306E\u64CD\u4F5C\u306F\u5143\u306B\u623B\u305B\u307E\u305B\u3093\u3002')) {
            this.progress = {};
            this.quizResults = {};
            localStorage.removeItem('recruitment-progress');
            localStorage.removeItem('recruitment-quiz-results');
            this.buildSidebar();
            this.updateGlobalProgress();
            this.showDashboard();
        }
